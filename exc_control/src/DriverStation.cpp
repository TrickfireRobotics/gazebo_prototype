...
int main(int argc, char **argv)
{
  ...
  ros::Publisher turn_pub = n.advertise<std_msgs::Float64>("exc/turntable_position_controller/command", 1);
  ros::Publisher lower_arm_pub = n.advertise<std_msgs::Float64>("exc/lower_arm_position_controller/command", 1);
  ros::Publisher upper_arm_pub = n.advertise<std_msgs::Float64>("exc/upper_arm_position_controller/command", 1);
